...
results <- process_with_auto_restart(
  ...
  checkpoint_file = "data/my_openai_checkpoint.rds",  # Your personal checkpoint
  batch_size = 10,
  max_consecutive_failures = 3,
  pause_duration_minutes = 0.017
)

#############################Ran here

results <- readRDS("data/my_openai_checkpoint.rds")

# View the data table
View(results)

# file.copy("data/my_openai_checkpoint.rds", "data/tag_1460.rds")

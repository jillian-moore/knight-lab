# standalone_ward_comparison.R
# Standalone app for comparing two Chicago community areas
...
ui <- fluidPage(
  ...
  fluidRow(
    ...
    column(6,
           div(class = "control-section",
               ...
               selectInput("ward2", NULL,
                           choices = community_choices,
                           selected = community_choices[2])
           )
    )
  ),
  ...
  fluidRow(
    ...
    column(6,
           div(class = "control-section",
               ...
               plotOutput("pie_chart", height = "350px")
           )
    )
  ),
  ...
  fluidRow(
    column(12,
           div(class = "control-section",
               h4("Topics by Year"),
               plotOutput("stacked_bar", height = "400px")
           )
    )
  )
)
